    ...
    addPrismTool: () => {
        ...
        var r = Prism.plugins.toolbar.hook = function (a) {
            ...
            if (isEnableCopy) {
                ...
                copy.className = 'icon-paste copy-button code-copy cursor-pointer'
            ...
            if (isEnableExpander) {
                ...
                expander.className = 'fa-sharp fa-solid icon-angle-down code-expander cursor-pointer'
            ...
            if (isEnableHeightLimit && r.offsetHeight > prismLimit) {
                ...
                ele.innerHTML = '<i class="icon-angle-double-down"></i>';
