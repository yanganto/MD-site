...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // 此處可以更改為你想要顯示的文字
    const rightMenuMsgToTraditionalChinese = '<i class="icon-fanti" style="font-size: 19px;"></i><span>轉為繁體</span>'
    // 同上，但兩處均不建議更改
    const rightMenuMsgToSimplifiedChinese = '<i class="icon-jianti" style="font-size: 19px;"></i><span>转为简体</span>'
